  ...
  return (
    <div>
      ...
      <div className="page-header d-flex justify-content-between align-items-start">
        ...
        <Link href="/amministrazione/uffici/nuovo" className="btn btn-primary">
          Nuovo Ufficio
        </Link>
      </div>
            ...
            <div key={ufficio.id} className="col-12 col-md-6 col-lg-4">
              <Card>
                <CardBody>
                  ...
                  <div className="mb-3">
                    <strong>{ufficio._count.fasi}</strong>
                    <span className="text-muted ms-1">fasi assegnate</span>
                  </div>
                  {ufficio.email && (
                  ...
                  <Link
                    href={`/amministrazione/uffici/${ufficio.id}`}
