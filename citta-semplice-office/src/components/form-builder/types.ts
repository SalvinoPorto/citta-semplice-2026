import type { FieldType, FormField } from '@citta/form-schema';

/**
 * Metadati della palette del form builder: solo UI dell'office.
 * Tipi, condizioni, pagine e riepilogo dello schema stanno in `@citta/form-schema`.
 */
