...
export const Paginatore: React.FC<PaginatoreProps> = ({ page, pages, onChange }) => {
    ...
    if (first > 1) {
        ...
        items.push(
            <li key={key++} className='page-item page-link disabled'>
                ...
            </li>
        );
    }
    ...
    return (
        <ul className="pagination">
            <li className="page-item">
                <button className="page-link" onClick={triggerPrev}>Precedente</button>
            </li>
            {items}
            <li className="page-item">
                <button className="page-link" onClick={triggerNext}>Successiva</button>
            </li>
        </ul>
    );
};
